...
import com.main.map.models.JSONclasses.GettingAdditionalInfo;
import com.main.map.models.JSONclasses.factoryMethod.AdditionalInfo;
import com.main.map.models.JSONclasses.factoryMethod.Creator;
...
public class MapRestController {
    ...
    public String GetMoreInformation(@RequestParam(value="lat", required=false, defaultValue="World") double lat,
                                     ...
                                     @RequestParam(value="houseLat") double houseLat,
                                     @RequestParam(value="houseLng") double houseLng){
       ...
       // Company date = moreInformation.getDataFromBase();
        ...
        Creator creator = GettingAdditionalInfo.getCreator(type);
        return creator.createAdditionalInfo(lat, lon,distance);


//                new AdditionalInfo(date.getName(),
